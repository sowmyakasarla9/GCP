...
DATABASE ='/home/sowmyareddykasarla99/cloudcomputing_assignment-4/GCP/example.db'
app = Flask(__name__)
...
def chatbotsystem():
    ...
    if request.method == 'POST' and str(request.form['question']) !="":
        ...
        if(questionasked in "Does the college have a football team?"):
            ChatWindowHTMLMiddle="""
            </br><label for="ufname" style="color:grey;"><strong>"""+questionasked+"""</strong></label></br>
...
def endchat():
    ...
    [Creator Details]<br>
    <label for="ufname"><strong>Sowmya, Kasarla, kasarlsm@mail.uc.edu</strong></label></br></br>
    """
